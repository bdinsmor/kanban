...
const today = moment().minutes(0).valueOf();
...
export const kanbanData = [
  {
    ...
    values: [
      {
        'name': 'Brady Anderson',
        'approvalDate': todayDate.add(-120, 'days'),
        'nextMeetingDate': todayDate.add(3, 'days'),
        'status': '#7986CC'
      },
      {
        'name': 'Joe Orsulak',
        'approvalDate': todayDate.add(-10, 'days'),
        'nextMeetingDate': todayDate.add(13, 'days'),
        'status': '#7986CC'
      },
      {
        'name': 'Glenn Davis',
        'approvalDate': todayDate.add(-90, 'days'),
        'nextMeetingDate': todayDate.add(23, 'days'),
        'status': '#7986CC'
      },
      {
        'name': 'Randy Ready',
        'approvalDate': todayDate.add(-85, 'days'),
        'nextMeetingDate': todayDate.add(7, 'days'),
        'status': '#7986CC'
      },
      {
        'name': 'Randy Milligan',
        'approvalDate': todayDate.add(-360, 'days'),
        'nextMeetingDate': todayDate.add(10, 'days'),
        'status': '#7986CC'
      },
      {
        'name': 'Brady Anderson',
  ...
  {key: 'Recruited',
    values: [
      {
        'name': 'Cal Ripken',
        'approvalDate': todayDate.add(-220, 'days'),
        'nextMeetingDate': todayDate.add(4, 'days'),
        'status': '#7986CC'
      },
      {
        'name': 'Billy Ripken',
        'approvalDate': todayDate.add(-10, 'days'),
        'nextMeetingDate': todayDate.add(11, 'days'),
        'status': '#FFD54F'
      },
      {
        'name': 'Sam Horn',
      ...
      },
      {
        'name': 'Jim Palmer',
        'approvalDate': todayDate.add(-85, 'days'),
        'nextMeetingDate': todayDate.add(17, 'days'),
        'status': '#7986CC'
      },
      {
        'name': 'Larry Sheets',
        'approvalDate': todayDate.add(-50, 'days'),
        'nextMeetingDate': todayDate.add(14, 'days'),
        'status': '#FFD54F'
      }
    ]
  }
